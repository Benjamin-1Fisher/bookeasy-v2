  ...
  return (
    <main className="min-h-screen bg-background py-10">
      <article className="container-shell max-w-3xl rounded-[8px] border border-line bg-white p-6 leading-8">
        ...
        <p>
          BookEasy מיועד להצגת שירותים, זמינות וקביעת תורים לעסקים קטנים. בעל העסק אחראי לוודא שהמידע שמוצג ללקוחות
          נכון, מעודכן ומתאים לפעילות שלו.
        </p>
        <h2 className="mt-8 text-2xl font-extrabold">הזמנות ותקשורת עם לקוחות</h2>
        <p>
          תור שנקבע דרך המערכת נכנס ללוח הניהול של העסק. בעל העסק אחראי למדיניות ביטולים, שינויים ותקשורת עם לקוחות
          במקרה של שינוי במועד.
        </p>
